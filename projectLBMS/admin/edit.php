...
$y=mysql_query("select * from `adduser` where `M_id`='$M_id'");
...
<tr><td> Name</td><td><input type="text" name="a" value="<?php echo $a;?>"/></td></tr><br /><br />
<tr><td>Address</td><td><input type="text" name="d" value="<?php echo $d;?>"/></td></tr><br /><br />
<tr><td>Contact</td><td><input type="text" name="e" value="<?php echo $e;?>"/></td></tr><br /><br />
<tr><td>E_mail</td><td><input type="email" name="f" value="<?php echo $f;?>"/></td></tr><br /><br />

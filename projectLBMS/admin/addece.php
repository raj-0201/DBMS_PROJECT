...
<body>
<form action="addecedb.php" method="post">
<div>
<div id="a">
...
<tr align="center"><td><font color="#00FF00">MIS</font></td><td><input type="text" placeholder="enter rollno" style="margin-left:20px;" name="roll" required="" pattern="[0-9]{7}"/></td></tr>
